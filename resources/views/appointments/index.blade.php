    ...
    <div class="d-flex justify-content-center align-items-center">
        <div class="card border-0 shadow-lg rounded-3" style="width: 100%;">
            <div class="card-body p-4">
                ...
                <!-- Formulário de Busca -->
                <form action="{{ route('appointments') }}" method="GET" class="mb-4">
                    <div class="input-group">
                        <input type="text" name="query" class="form-control" placeholder="Buscar por paciente ou data"
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @forelse($appointments as $appointment)
                                <tr>
                                    <td>{{ \Carbon\Carbon::parse($appointment->data_hora_inicio)->timezone('America/Sao_Paulo')->format('d/m/Y H:i') }}</td>
                                    <td>{{ \Carbon\Carbon::parse($appointment->data_hora_fim)->timezone('America/Sao_Paulo')->format('d/m/Y H:i') }}</td>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $start = \Carbon\Carbon::parse($appointment->data_hora_inicio, 'America/Sao_Paulo');
                                            $end = \Carbon\Carbon::parse($appointment->data_hora_fim, 'America/Sao_Paulo');
